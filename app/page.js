...
export default function Home() {
  return (
    <main className="m-5">
      ...
      <section>
        <ul>
          <li className="text-blue-400 hover:text-blue-700 mt-3 hover:underline rounded-lg border border-gray-300 p-2 max-w-xs mx-auto px-10 py-4 text-center dark:bg-gray-800 dark:border-gray-800 shadow-md">
